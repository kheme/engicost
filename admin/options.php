...
echo "<script type=\"text/javascript\">alert('Your new settings have been saved!');location.replace('./')</script>";
}
}
}
...
<body>
<?toplink()?>
<p align="center"><strong style="font-size:10pt">Options &amp; Settings</strong>
